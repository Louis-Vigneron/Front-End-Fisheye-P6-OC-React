...
class PictureCard {
    ...
    createPictureCard(){      
        ...
        <figure >
            ...
            <figcaption class="img-legend">${this.picture.Title}<span class="likes-number"> ${this.picture.Likes}<i tabindex="0" class="fa-solid fa-heart"></i></span></figcaption>
        </figure>
    `
    return pictureCard
    }    
...
class VideoCard {
    ...
    createVideoCard(){      
        ...
        <figure>
             ...
             <figcaption class="img-legend">${this.data.Title}<span class="likes-number"> ${this.data.Likes}<i tabindex="0" class="fa-solid fa-heart"></i></span></figcaption>
         </figure>
    `
    return videoCard
    }    
